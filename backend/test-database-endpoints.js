...
async function testDatabaseEndpoints() {
    try {
        ...
        console.log('3️⃣ Listando tablas de la base de datos...');
        ...
        console.log('4️⃣ Consultando tabla "usuarios"...');
        ...
        console.log('5️⃣ Ejecutando consulta SQL personalizada...');
        ...
        console.log('6️⃣ Obteniendo estadísticas de la base de datos...');
        ...
        console.log('7️⃣ Probando consulta no permitida (UPDATE)...');
        try {
            await axios.post(
                `${API_URL}/database/query`,
